# LyricVault v0.3.5 Clean-Machine Smoke Test
...
## Installer Path
1. Run `LyricVault Setup 0.3.5.exe`.
...
6. Verify playback, queue controls, and lyrics behavior.

## Portable Path
1. Run `LyricVault 0.3.5.exe` from a non-admin folder.
...
5. Close and reopen portable binary; verify library behaves correctly.
