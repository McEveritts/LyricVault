...
```powershell
git add CHANGELOG.md README.md package.json package-lock.json frontend/package.json frontend/package-lock.json backend/main.py electron/preload.js frontend/index.html frontend/src/components/SettingsView.jsx release_notes_v0.4.2.md release_publish_v0.4.2.md smoke_test_v0.4.2.md release_checksums_v0.4.2.txt
git commit -m "release: finalize v0.4.2 metadata and checksums"
```
...
2. Tag: `v0.4.2`
3. Title: `LyricVault v0.4.2`
4. Notes: paste `release_notes_v0.4.2.md`
5. Upload assets:
   - `release/LyricVault Setup 0.4.2.exe`
   - `release/LyricVault 0.4.2.exe`
